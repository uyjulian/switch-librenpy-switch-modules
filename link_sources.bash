...
# ln -sf $(realpath pygame_sdl2-source/sdl2.c) source/module/sdl2.c
...
# ln -sf $(realpath renpy-source/module/egl_angle.c) source/module/egl_angle.c
ln -sf $(realpath renpy-source/module/egl_none.c) source/module/egl_none.c
# ln -sf $(realpath renpy-source/module/egl_x11.c) source/module/egl_x11.c
ln -sf $(realpath renpy-source/module/ffmedia.c) source/module/ffmedia.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-arabic.c) source/module/fribidi-arabic.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-bidi-types.c) source/module/fribidi-bidi-types.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-bidi.c) source/module/fribidi-bidi.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-deprecated.c) source/module/fribidi-deprecated.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-joining-types.c) source/module/fribidi-joining-types.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-joining.c) source/module/fribidi-joining.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-mem.c) source/module/fribidi-mem.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-mirroring.c) source/module/fribidi-mirroring.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-run.c) source/module/fribidi-run.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-shape.c) source/module/fribidi-shape.c
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi.c) source/module/fribidi.c
...
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.gl.c) source/module/renpy.angle.gl.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.gldraw.c) source/module/renpy.angle.gldraw.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.glenviron_shader.c) source/module/renpy.angle.glenviron_shader.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.glrtt_copy.c) source/module/renpy.angle.glrtt_copy.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.glrtt_fbo.c) source/module/renpy.angle.glrtt_fbo.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.angle.gltexture.c) source/module/renpy.angle.gltexture.c
...
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl.gl1.c) source/module/renpy.gl.gl1.c
ln -sf $(realpath renpy-source/module/gen-static/renpy.gl.gldraw.c) source/module/renpy.gl.gldraw.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl.glenviron_fixed.c) source/module/renpy.gl.glenviron_fixed.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl.glenviron_limited.c) source/module/renpy.gl.glenviron_limited.c
...
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl2.gl2geometry.c) source/module/renpy.gl2.gl2geometry.c
...
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl2.uguu.c) source/module/renpy.gl2.uguu.c
# ln -sf $(realpath renpy-source/module/gen-static/renpy.gl2.uguugl.c) source/module/renpy.gl2.uguugl.c
...
# ln -sf $(realpath renpy-source/module/gl2debug.c) source/module/gl2debug.c
...
ln -sf $(realpath renpy-source/module/fribidi-src/config.h) include/module/config.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/arabic-misc.tab.i) include/module/fribidi-src/lib/arabic-misc.tab.i
ln -sf $(realpath renpy-source/module/fribidi-src/lib/arabic-shaping.tab.i) include/module/fribidi-src/lib/arabic-shaping.tab.i
ln -sf $(realpath renpy-source/module/fribidi-src/lib/bidi-type.tab.i) include/module/fribidi-src/lib/bidi-type.tab.i
ln -sf $(realpath renpy-source/module/fribidi-src/lib/bidi-types.h) include/module/bidi-types.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/common.h) include/module/common.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/debug.h) include/module/debug.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-arabic.h) include/module/fribidi-src/lib/fribidi-arabic.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-begindecls.h) include/module/fribidi-src/lib/fribidi-begindecls.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-bidi-types-list.h) include/module/fribidi-src/lib/fribidi-bidi-types-list.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-bidi-types.h) include/module/fribidi-src/lib/fribidi-bidi-types.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-bidi.h) include/module/fribidi-src/lib/fribidi-bidi.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-common.h) include/module/fribidi-src/lib/fribidi-common.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-config.h) include/module/fribidi-src/lib/fribidi-config.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-deprecated.h) include/module/fribidi-src/lib/fribidi-deprecated.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-enddecls.h) include/module/fribidi-src/lib/fribidi-enddecls.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-flags.h) include/module/fribidi-src/lib/fribidi-flags.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-joining-types-list.h) include/module/fribidi-src/lib/fribidi-joining-types-list.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-joining-types.h) include/module/fribidi-src/lib/fribidi-joining-types.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-joining.h) include/module/fribidi-src/lib/fribidi-joining.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-mirroring.h) include/module/fribidi-src/lib/fribidi-mirroring.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-shape.h) include/module/fribidi-src/lib/fribidi-shape.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-types.h) include/module/fribidi-src/lib/fribidi-types.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-unicode-version.h) include/module/fribidi-src/lib/fribidi-unicode-version.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi-unicode.h) include/module/fribidi-src/lib/fribidi-unicode.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/fribidi.h) include/module/fribidi-src/lib/fribidi.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/joining-type.tab.i) include/module/fribidi-src/lib/joining-type.tab.i
ln -sf $(realpath renpy-source/module/fribidi-src/lib/joining-types.h) include/module/fribidi-src/lib/joining-types.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/mem.h) include/module/fribidi-src/lib/mem.h
ln -sf $(realpath renpy-source/module/fribidi-src/lib/mirroring.tab.i) include/module/fribidi-src/lib/mirroring.tab.i
ln -sf $(realpath renpy-source/module/fribidi-src/lib/run.h) include/module/fribidi-src/lib/run.h
...
# ln -sf $(realpath renpy-source/module/uguu/renpygl.h) include/module/renpygl.h
